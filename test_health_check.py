...
from backend.utils.health_check import (
    HealthCheck, HealthStatus, ServiceType, health_check_registry,
    check_system_health, check_network_health
)
...
class TestHealthCheck(unittest.TestCase):
    ...
    def test_network_health_success(self, mock_getaddrinfo):
        ...
        with patch('backend.utils.health_check.socket.socket', return_value=mock_socket):
