...
class UltraData(UltraBase):
    ...
    def _apply_scaling(self, df: pd.DataFrame, scale_params: Dict[str, Any]) -> pd.DataFrame:
    ...
    def _apply_filtering(self, df: pd.DataFrame, filter_params: Dict[str, Any]) -> pd.DataFrame:
    ...
    def _apply_transformation(self, df: pd.DataFrame, transform_params: Dict[str, Any]) -> pd.DataFrame:
