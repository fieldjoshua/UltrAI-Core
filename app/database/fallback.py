...
class FallbackSession:
    ...
    def add(self, instance: Any) -> None:
        ...
        if not hasattr(instance, "__table__"):
            logger.warning(
                f"Cannot add instance without __table__ attribute: {instance}"
            )
            return
    ...
    def delete(self, instance: Any) -> None:
        ...
        if not hasattr(instance, "__table__"):
            logger.warning(
                f"Cannot delete instance without __table__ attribute: {instance}"
            )
            return
        ...
        # Add operation to pending list
        self.pending_operations.append(
            {"type": "delete", "table": table_name, "pk_value": pk_value}
        )
    ...
    def refresh(self, instance: Any, attribute_names: Optional[Sequence[str]] = None) -> None:
        """Refresh an instance by reloading from the database"""
        # For memory DB, we don't need to do anything since objects are already in memory
        # In a real session, this would reload the object's attributes from the DB
        pass
