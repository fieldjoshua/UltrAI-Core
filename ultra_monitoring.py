...
class UltraMetrics:
    ...
    def get_summary(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "current_disk_usage": self.metrics["disk_usage"][-1] if self.metrics["disk_usage"] else 0
        }
...
class SystemMonitor:
    ...
    def get_system_status(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "memory_usage": self.metrics.metrics["memory_usage"][-1] if self.metrics.metrics["memory_usage"] else 0,
            "cpu_usage": self.metrics.metrics["cpu_usage"][-1] if self.metrics.metrics["cpu_usage"] else 0,
            "disk_usage": self.metrics.metrics["disk_usage"][-1] if self.metrics.metrics["disk_usage"] else 0
        }
