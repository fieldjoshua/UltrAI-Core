...
def test_elliptic_integrals():
    ...
    assert ellipe(0.5).ae(
        pi ** (mpf(3) / 2) / gamma(0.25) ** 2 + gamma(0.25) ** 2 / (8 * sqrt(pi))
    )
    assert ellipe(1) == 1
    ...
    assert ellipk(-10 * pi).ae(
        "0.5519067523886233967683646782286965823151896970015484512"
    )
    assert ellipe(-10 * pi).ae(
        "5.926192483740483797854383268707108012328213431657645509"
    )
    v = ellipk(pi)
...
def test_e1():
    ...
    assert e1(fmul(10**20, j, exact=True)).ae(
        6.4525128526578084421e-21 - 7.6397040444172830039e-21j,
        abs_eps=0,
        rel_eps=8 * eps,
    )
    assert e1(-10j).ae(0.045456433004455372635 - 0.087551267423977430100j)
...
def test_expint():
    ...
    assert expint(2 + 3j, 4 - j).ae(
        0.0023461179581675065414 + 0.0020395540604713669262j
    )
...
def test_airy():
    ...
    assert (airyai(100 + 100j) * 10**188).ae(
        2.9099582462207032076 + 2.353013591706178756j
    )
    assert (airybi(100 + 100j) / 10**185).ae(
        1.7086751714463652039 - 3.1416590020830804578j
    )
...
def test_hyper_0f1():
    ...
    assert hyp0f1(3, 1e9j).ae(
        "-2.1222788784457702157e+19410 + 5.0840597555401854116e+19410j"
    )
...
def test_hyper_1f1():
    ...
    assert (hyp1f1(2, 3, 1e10j) * 10**10).ae(
        -0.97501205020039745852 - 1.7462392454512132074j
    )
...
def test_hyper_2f1_hard():
    ...
    assert hyp2f1(2, -5, -5, 0.25 + 0.25j, eliminate=False).ae(
        163.0 / 128 + 125.0 / 128 * j
    )
    ...
    assert hyp2f1(0.25, (1, 3), 2, "1.001").ae(
        1.06867299254830309446 - 0.00001446586793975874j
    )
    assert hyp2f1(0.25, (1, 3), 2, -1).ae(0.96656584492524351673)
    assert hyp2f1(0.25, (1, 3), 2, j).ae(
        0.99041766248982072266 + 0.03777135604180735522j
    )
    ...
    assert fsum(
        [hyp2f1((7, 10), (2, 3), (-1, 2), 0.95 * exp(j * k)) for k in range(1, 15)]
    ).ae(52.851400204289452922 + 6.244285013912953225j)
    assert fsum(
        [hyp2f1((7, 10), (2, 3), (-1, 2), 1.05 * exp(j * k)) for k in range(1, 15)]
    ).ae(54.506013786220655330 - 3.000118813413217097j)
    assert fsum(
        [hyp2f1((7, 10), (2, 3), (-1, 2), exp(j * k)) for k in range(1, 15)]
    ).ae(55.792077935955314887 + 1.731986485778500241j)
    ...
    assert hyp2f1(1, 1, 2, 1.01 + 0.1j).ae(
        2.4149427480552782484 + 1.4148224796836938829j
    )
...
def test_hyper_3f2_etc():
    ...
    assert hyper([1, 2, 3, 4], [5, 6, 7], 5).ae(
        1.5192307344006649499 - 1.1529845225075537461j
    )
...
def test_hyper_2f0():
    ...
    assert hyp2f0(0.5, 0.25, 3 + 4j).ae(
        0.85548875824755163518 + 0.21636041283392292973j
    )
...
def test_hyper_1f2():
    ...
    assert hyp1f2(a1, b1, b2, 10 * j).ae(
        -16.163252524618572878 - 44.321567896480184312j
    )
    assert hyp1f2(a1, b1, b2, 100 * j).ae(
        61938.155294517848171 + 637349.45215942348739j
    )
    assert hyp1f2(a1, b1, b2, 1000 * j).ae(
        8455057657257695958.7 + 6261969266997571510.6j
    )
    assert hyp1f2(a1, b1, b2, 10000 * j).ae(
        -8.9771211184008593089e60 + 4.6550528111731631456e59j
    )
    assert hyp1f2(a1, b1, b2, 100000 * j).ae(
        2.6398091437239324225e193 + 4.1658080666870618332e193j
    )
...
def test_hyper_2f3():
    ...
    assert hyp2f3(a1, a2, b1, b2, b3, 10 * j).ae(
        -18.551602185587547854 - 13.348031097874113552j
    )
    assert hyp2f3(a1, a2, b1, b2, b3, 100 * j).ae(
        78634.359124504488695 + 74459.535945281973996j
    )
    assert hyp2f3(a1, a2, b1, b2, b3, 1000 * j).ae(
        597682550276527901.59 - 65136194809352613.078j
    )
...
def test_hyper_2f2():
    ...
    assert hyp2f2(a1, a2, b1, b2, 10**20).ae(
        "1.1148680024303263661e+43429448190325182840"
    )
...
def test_hermite():
    ...
    assert hermite(-9.5, -2.5j).ae(
        -2.9004951258126778174e-6 - 1.7601372934039951100e-6j
    )
...
def test_gegenbauer():
    ...
    assert gegenbauer(2 + 3j, 1 - j, 3 + 4j).ae(
        14.880536623203696780 + 20.022029711598032898j
    )
...
def test_legenp():
    ...
    assert legenp(2 + j, 3 + 4j, -j, type=3).ae(
        802.59463394152268507 - 251.62481308942906447j
    )
...
def test_legenq():
    ...
    assert f(2, 3, -0.5, type=2).ae(-12.316805742712016310)
    assert f(2, 3, -0.5, type=3).ae(-12.316805742712016310j)
    assert f(2 + 3j, 3 + 4j, 0.5, type=3).ae(
        0.0016119404873235186807 - 0.0005885900510718119836j
    )
    assert f(2 + 3j, 3 + 4j, -1.5, type=3).ae(
        0.008451400254138808670 + 0.020645193304593235298j
    )
...
def test_gammainc():
    ...
    assert gammainc(0, 2 + j, 1 - j).ae(
        0.00910653685850304839 - 0.22378752918074432574j
    )
    ...
    assert gammainc(-1000000, 2).ae(
        "1.3669297209397347754e-301037", abs_eps=0, rel_eps=8 * eps
    )
    assert gammainc(-1000000, 2, regularized=True) == 0
    assert gammainc(-1000000, 3 + 4j).ae(
        "-1.322575609404222361e-698979 - 4.9274570591854533273e-698978j",
        abs_eps=0,
        rel_eps=8 * eps,
    )
    ...
    assert gammainc(5, 10000, 12000).ae(
        "1.1359381951461801687e-4327", abs_eps=0, rel_eps=8 * eps
    )
...
def test_erf():
    ...
    assert (erfc(10) * 10**45).ae(
        "2.0884875837625447570007862949577886115608181193212"
    )
    # This one does
    assert (erfc(50) * 10**1088).ae(
        "2.0709207788416560484484478751657887929322509209954"
    )
    mp.dps = 15
    assert (
        str(erfc(10**50))
    ...
    assert (erfc(100 + 5j) * 10**4335).ae(
        2.3973567853824133572 - 3.9339259530609420597j
    )
...
def test_lambertw():
    ...
    assert lambertw(-1.0 / 100000, 5).ae(
        -15.0931437726379218666 + 32.5525721210262290086j
    )
    ...
    assert lambertw(-0.448 - 0.4j).ae(-0.11855133765652382241 - 0.66570534313583423116j)
    assert lambertw(-0.65475 + 0.0001j).ae(
        -0.61053421111385310898 + 1.0396534993944097723803j
    )
    # Huge branch index
    w = lambertw(1, 10**20)
...
def test_lambertw_hard():
    ...
    assert check(
        lambertw(1e-10j), 9.999999999999999999733e-21 + 9.99999999999999999985e-11j
    )
    assert check(
        lambertw(-1e-10j), 9.999999999999999999733e-21 - 9.99999999999999999985e-11j
    )
    ...
    # -1/e - eps
    assert check(
        lambertw(sub(a, d3)), -0.99819016149860989001 + 0.07367191188934638577j
    )
    assert check(
        lambertw(sub(a, d10)),
        -0.9999999998187812114595992 + 0.0000233164398140346109194j,
    )
    assert check(
        lambertw(sub(a, d20)), -0.99999999999999999998187 + 2.331643981597124203344e-10j
    )
    ...
    # -1/e + eps*j
    assert check(
        lambertw(addj(a, d3)), -0.94790387486938526634 + 0.05036819639190132490j
    )
    assert check(
        lambertw(addj(a, d10)),
        -0.9999835127872943680999899 + 0.0000164870314895821225256j,
    )
    assert check(
        lambertw(addj(a, d20)),
        -0.999999999835127872929987 + 1.64872127051890935830e-10j,
    )
    assert check(
        lambertw(addj(a, d40)),
        -0.9999999999999999999835 + 1.6487212707001281468305e-20j,
    )
    ...
    # -1/e - eps*j
    assert check(
        lambertw(subj(a, d3)), -0.94790387486938526634 - 0.05036819639190132490j
    )
    assert check(
        lambertw(subj(a, d10)),
        -0.9999835127872943680999899 - 0.0000164870314895821225256j,
    ...
    # ---- Branch 1 ----
    assert check(
        lambertw(addj(a, d3), 1),
        -3.088501303219933378005990 + 7.458676867597474813950098j,
    )
    assert check(
        lambertw(addj(a, d80), 1),
        -3.088843015613043855957087 + 7.461489285654254556906117j,
    )
    assert check(
        lambertw(addj(a, d300), 1),
        -3.088843015613043855957087 + 7.461489285654254556906117j,
    )
    assert check(
        lambertw(addj(a, d1000), 1),
        -3.088843015613043855957087 + 7.461489285654254556906117j,
    )
    assert check(
        lambertw(subj(a, d3), 1),
        -1.0520914180450129534365906 + 0.0539925638125450525673175j,
    )
    assert check(
        lambertw(subj(a, d10), 1),
        -1.0000164872127056318529390 + 0.000016487393927159250398333077j,
    )
    assert check(
        lambertw(subj(a, d20), 1),
        -1.0000000001648721270700128 + 1.64872127088134693542628e-10j,
    )
    assert check(
        lambertw(subj(a, d40), 1),
        -1.000000000000000000016487 + 1.64872127070012814686677e-20j,
    )
    ...
    assert check(
        lambertw(subj(a, d1000), 1), mpc(-1.0, "1.64872127070012814684865e-500")
    )
    # ---- Branch -1 ----
    # -1/e + eps
    ...
    # -1/e - eps
    assert check(
        lambertw(sub(a, d3), -1), -0.99819016149860989001 - 0.07367191188934638577j
    )
    assert check(
        lambertw(sub(a, d10), -1),
        -0.9999999998187812114595992 - 0.0000233164398140346109194j,
    )
    assert check(
        lambertw(sub(a, d20), -1),
        -0.99999999999999999998187 - 2.331643981597124203344e-10j,
    )
    ...
    assert check(
        lambertw(addj(a, d10), -1),
        -1.0000164872127056318529390 - 0.0000164873939271592503983j,
    )
    assert check(
        lambertw(addj(a, d20), -1),
        -1.0000000001648721270700 - 1.64872127088134693542628e-10j,
    )
    assert check(
        lambertw(addj(a, d40), -1),
        -1.00000000000000000001648 - 1.6487212707001281468667726e-20j,
    )
    ...
    assert check(
        lambertw(addj(a, d1000), -1), mpc(-1.0, "-1.64872127070012814684865e-500")
    )
    # -1/e - eps*j
    assert check(
        lambertw(subj(a, d3), -1),
    ...
    assert check(
        lambertw(subj(a, d10), -1),
        -3.088843015579260686911033 - 7.461489285372968780020716j,
    )
    assert check(
        lambertw(subj(a, d20), -1),
        -3.088843015613043855953708 - 7.461489285654254556877988j,
    )
    assert check(
        lambertw(subj(a, d40), -1),
        -3.088843015613043855957087 - 7.461489285654254556906117j,
    ...
    assert check(
        lambertw(subj(a, d80), -1),
        -3.088843015613043855957087 - 7.461489285654254556906117j,
    )
    assert check(
        lambertw(subj(a, d300), -1),
        -3.088843015613043855957087 - 7.461489285654254556906117j,
    )
    assert check(
        lambertw(subj(a, d1000), -1),
        -3.088843015613043855957087 - 7.461489285654254556906117j,
    )
...
def test_meijerg():
    ...
    assert meijerg([[0], []], [[0, 0, "1/3", "2/3"], []], "2/27").ae(
        2.2019391389653314120
    )
...
def test_hyper_param_accuracy():
    ...
    assert (hyp2f1(1000, 1.5, -3.5, -0.75, maxterms=100000) * 10**231).ae(
        -4.0534790813913998643
    )
    assert legenp(2, 3, 0.25) == 0
    pytest.raises(
        ValueError, lambda: hypercomb(lambda a: [([], [], [], [], [a], [-a], 0.5)], [3])
    )
    assert (
        hypercomb(lambda a: [([], [], [], [], [a], [-a], 0.5)], [3], infprec=200) == inf
    )
...
def test_spherharm():
    ...
    assert spherharm(2, -3, t, r) == 0
    assert spherharm(2, -4, t, r) == 0
    assert spherharm(3, 4.5, 0.5, 0.25).ae(
        -22.831053442240790148 + 10.910526059510013757j
    )
    ...
    assert spherharm(-3.5, 3, 0.5, 0.25).ae(
        0.014516852987544698924 - 0.015582769591477628495j
    )
    assert spherharm(-3, 3, 0.5, 0.25) == 0
    assert spherharm(-6, 3, 0.5, 0.25).ae(
        -0.16544349818782275459 - 0.15412657723253924562j
    )
    assert spherharm(-6, 1.5, 0.5, 0.25).ae(
        0.032208193499767402477 + 0.012678000924063664921j
    )
...
def test_issue_239():
    ...
    assert betainc(206, 385, 0, 0.55, 1).ae(
        "0.99999999999999999999996570910644857895771110649954"
    )
    mp.dps = 15
