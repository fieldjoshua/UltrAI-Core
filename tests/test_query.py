...
from sympy.assumptions.assume import Predicate, assuming, global_assumptions
...
from sympy.core.numbers import I, Integer, Rational, oo, pi, zoo
...
def test_imaginary():
    ...
    assert (
        ask(Q.imaginary(x**y), Q.real(x) & Q.rational(y) & Q.integer(2 * y)) is None
    )
