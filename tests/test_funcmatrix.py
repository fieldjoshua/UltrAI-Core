from sympy.core import Lambda, symbols
from sympy.core.sympify import SympifyError
from sympy.functions import KroneckerDelta
from sympy.matrices import Matrix
from sympy.matrices.expressions import FunctionMatrix, Identity, MatrixExpr
...
def test_funcmatrix_creation():
    ...
    assert FunctionMatrix(2, 2, "lambda i, j: 0") == FunctionMatrix(
        2, 2, Lambda((i, j), 0)
    )
