...
def test_construct_c_case_1():
    ...
    tests = [
        (
            ...
            Poly(
                4 * x**8 + 16 * x**7 + 9 * x**5 + 12 * x**4 + 6 * x**3 + 12 * x**2,
                x,
                extension=True,
            ),
            S(0),
        ...
        (
            ...
            Poly(
                128 * x**5 - 656 * x**4 + 1264 * x**3 - 1125 * x**2 + 385 * x + 49,
                x,
                extension=True,
            ),
            S(7) / 4,
...
def test_construct_d_case_4():
    ...
    tests = [
        ...
        (
            Poly(
                -(x**6) + 9 * x**5 + 5 * x**4 + 6 * x**3 + 5 * x**2 + 6 * x + 7,
                x,
                extension=True,
            ),
        ...
        (
            Poly(
                -2 * x**6 - x**5 - x**4 - 2 * x**3 - x**2 - 3 * x - 3, x, extension=True
            ),
        ...
        (
            Poly(
                -(x**7) - x**6 - 2 * x**5 - 2 * x**4 - x**3 - x**2 + 2 * x - 2,
                x,
                extension=True,
            ),
...
def test_construct_d_case_6():
    ...
    tests = [
        ...
        (
            ...
            Poly(
                x**6 - x**5 + 2 * x**4 - 4 * x**3 - 5 * x**2 - 5 * x + 9, x, domain="ZZ"
            ),
            [[1], [0]],
        ),
        (
...
def test_rational_laurent_series():
    ...
    tests = [
        ...
        (
            ...
            Poly(
                64 * x**4 - 80 * x**3 - 831 * x**2 + 1809 * x - 972, x, extension=True
            ),
            S(9) / 8,
            2,
            3,
        ...
        (
            ...
            Poly(
                7 * x**5 + 9 * x**4 + 8 * x**3 + 3 * x**2 + 6 * x + 9, x, extension=True
            ),
            oo,
            0,
            6,
...
def test_solve_riccati():
    ...
    tests = [
        ...
        (
            f(x) ** 2
            + f(x).diff(x)
            - (4 * x**6 - 8 * x**5 + 12 * x**4 + 4 * x**3 + 7 * x**2 - 20 * x + 4)
            / (4 * x**4),
            [
                Eq(
                    f(x),
