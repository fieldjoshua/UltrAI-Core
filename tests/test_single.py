            ...
            "fact_17": {
                ...
                "sol": [
                    Eq(
                        ...
                        C1
                        + Integral(
                            1 / sqrt(a0 + a1 * x + a2 * x**2 + a3 * x**3 + a4 * x**4), x
                        ),
                    )
                ],
                "slow": True,
    ...
    return {
        ...
        "examples": {
            ...
            "undet_16": {
                ...
                "sol": [
                    Eq(f(x), (C1 - x**2 / 8) * cos(2 * x) + (C2 + x / 16) * sin(2 * x))
                ],
                "slow": True,
            },
            "undet_17": {
            ...
            "2nd_lin_bessel_09": {
                ...
                "sol": [
                    Eq(
                        f(x),
                        x
                        * (C1 * besselj(S(1) / 2, x**2) + C2 * bessely(S(1) / 2, x**2)),
                    )
                ],
            },
            "2nd_lin_bessel_10": {
    ...
    return {
        ...
        "examples": {
            "separable_reduced_01": {
                ...
                "sol": [
                    Eq(
                        log(x**2 * f(x)) / 3 + log(x**2 * f(x) - Rational(3, 2)) / 6,
                        C1 + log(x),
                    )
                ],
                "simplify_flag": False,
            ...
            "separable_reduced_02": {
                ...
                "sol": [
                    Eq(
                        log(x**3 * f(x)) / 4 + log(x**3 * f(x) - Rational(4, 3)) / 12,
                        C1 + log(x),
                    )
                ],
                "simplify_flag": False,
