...
class TestRelease(unittest.TestCase):
    ...
    def test_repr(self):
        ...
        self.assertEquals("<Release 0.0.2>", release.__repr__())
    ...
    def test_release_python_version(self):
        release_id = "0.0.2"
        release = self.package.release(release_id)[0]
        self.assertEquals("2.7", release.python_version)
    ...
    def test_release_unknown_package_type(self):
        release_id = "0.0.0"
        release = self.package.release(release_id)[0]
        self.assertEquals("wheeeel", release.package_type)

    def test_release_package_type(self):
        release_id = "0.0.2"
        release = self.package.release(release_id)[0]
        self.assertEquals("wheel", release.package_type)
