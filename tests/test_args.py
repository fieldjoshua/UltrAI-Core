...
def test_sympy__codegen__ast__For():
    from sympy.codegen.ast import AddAugmentedAssignment, CodeBlock, For
...
def test_sympy__codegen__ast__Variable():
    from sympy.codegen.ast import Type, Variable, value_const
...
def test_sympy__codegen__ast__While():
    from sympy.codegen.ast import AddAugmentedAssignment, While

    assert _test_args(While(abs(x) < 1, [AddAugmentedAssignment(x, -1)]))


def test_sympy__codegen__ast__Scope():
    from sympy.codegen.ast import AddAugmentedAssignment, Scope
...
def test_sympy__codegen__ast__FunctionPrototype():
    from sympy.codegen.ast import Declaration, FunctionPrototype, Variable, real
...
def test_sympy__codegen__cnodes__union():
    from sympy.codegen.ast import Variable, float32, int32
...
def test_sympy__combinatorics__permutations__AppliedPermutation():
    from sympy.combinatorics.permutations import AppliedPermutation, Permutation
...
def test_sympy__sets__ordinals__Ordinal():
    from sympy.sets.ordinals import OmegaPower, Ordinal
...
def test_sympy__sets__sets__DisjointUnion():
    from sympy.sets.sets import DisjointUnion, FiniteSet
...
def test_sympy__stats__crv__ProductContinuousDomain():
    from sympy.sets.sets import Interval
    from sympy.stats.crv import ProductContinuousDomain, SingleContinuousDomain
...
def test_sympy__stats__crv__ConditionalContinuousDomain():
    from sympy.sets.sets import Interval
    from sympy.stats.crv import ConditionalContinuousDomain, SingleContinuousDomain
...
def test_sympy__stats__drv__ProductDiscreteDomain():
    from sympy.stats.drv import ProductDiscreteDomain, SingleDiscreteDomain
...
def test_sympy__stats__frv__ProductFiniteDomain():
    from sympy.stats.frv import ProductFiniteDomain, SingleFiniteDomain
...
def test_sympy__stats__frv__ConditionalFiniteDomain():
    from sympy.stats.frv import ConditionalFiniteDomain, SingleFiniteDomain
...
def test_sympy__stats__frv__ProductFinitePSpace():
    from sympy.core.symbol import Symbol
    from sympy.stats.frv import ProductFinitePSpace, SingleFinitePSpace
...
def test_sympy__physics__vector__frame__CoordinateSym():
    from sympy.physics.vector import CoordinateSym, ReferenceFrame
...
def test_sympy__physics__quantum__hilbert__TensorPowerHilbertSpace():
    from sympy.physics.quantum.hilbert import FockSpace, TensorPowerHilbertSpace
...
def test_sympy__physics__quantum__innerproduct__InnerProduct():
    from sympy.physics.quantum import Bra, InnerProduct, Ket
...
def test_sympy__physics__secondquant__InnerProduct():
    from sympy.physics.secondquant import FockStateBra, FockStateKet, InnerProduct
...
def test_sympy__physics__control__lti__Feedback():
    from sympy.physics.control import Feedback, TransferFunction
...
def test_sympy__tensor__tensor__TensorElement():
    from sympy.tensor.tensor import TensorElement, TensorHead, TensorIndexType
...
def test_sympy__tensor__tensor__WildTensor():
    from sympy.tensor.tensor import TensorIndex, TensorIndexType, WildTensorHead
...
def test_sympy__diffgeom__diffgeom__CoordinateSymbol():
    from sympy.diffgeom import CoordinateSymbol, CoordSystem, Manifold, Patch
...
def test_sympy__diffgeom__diffgeom__BaseScalarField():
    from sympy.diffgeom import BaseScalarField, CoordSystem, Manifold, Patch
...
def test_sympy__diffgeom__diffgeom__BaseVectorField():
    from sympy.diffgeom import BaseVectorField, CoordSystem, Manifold, Patch
...
def test_sympy__diffgeom__diffgeom__Commutator():
    from sympy.diffgeom import BaseVectorField, Commutator, CoordSystem, Manifold, Patch
...
def test_sympy__diffgeom__diffgeom__BaseCovarDerivativeOp():
    from sympy.diffgeom import BaseCovarDerivativeOp, CoordSystem, Manifold, Patch
...
def test_sympy__categories__baseclasses__Category():
    from sympy.categories import Category, Diagram, NamedMorphism, Object
