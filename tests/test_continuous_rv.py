...
from sympy.core.numbers import E as e
...
from sympy.sets.sets import Complement, FiniteSet, Intersection, Interval
...
from sympy.stats.crv import SingleContinuousDomain, SingleContinuousPSpace
...
from sympy.testing.pytest import XFAIL, ignore_warnings, raises, slow
...
def test_moment_generating_function():
    ...
    assert mgf == pi**2 * exp(a * t) * sinh(b * t) / (
        b * t * (b**2 * t**2 + pi**2)
    )
