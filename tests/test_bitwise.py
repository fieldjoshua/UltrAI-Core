...
def test_round_nearest():
    ...
    assert from_man_exp(0xF8, -4, 4, round_nearest)[:3] == (
        0,
        1,
        4,
    )  # 1111.1000 -> 10000.0
    assert from_man_exp(0xF9, -4, 4, round_nearest)[:3] == (
        0,
        1,
        4,
    )  # 1111.1001 -> 10000.0
    assert from_man_exp(0xE8, -4, 4, round_nearest)[:3] == (
        0,
        7,
        1,
    )  # 1110.1000 -> 1110.0
    assert from_man_exp(0xE9, -4, 4, round_nearest)[:3] == (
        0,
        15,
        0,
    )  # 1110.1001 -> 1111.0
