...
from sympy.ntheory.ecm import Point, ecm
...
def test_ecm():
    ...
    assert ecm(4269021180054189416198169786894227) == {
        184039,
        241603,
        333331,
        477973,
    ...
    assert ecm(7060005655815754299976961394452809, B1=100000, B2=1000000) == {
        6988699669998001,
        1010203040506070809,
    }
