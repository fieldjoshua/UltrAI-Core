...
def test_polytope_integrate():
    ...
    assert polytope_integrate(
        Polygon(Point(0, 0), Point(0, 1), Point(1, 1), Point(1, 0)), x * y
    ) == Rational(1, 4)
    assert polytope_integrate(
        Polygon(Point(0, 3), Point(5, 3), Point(1, 1)), 6 * x**2 - 40 * y
    ) == Rational(-935, 3)
    ...
    assert polytope_integrate(
        [((-1, 0), 0), ((0, 1), 1), ((1, 0), 1), ((0, -1), 0)], x * y
    ) == Rational(1, 4)
    assert polytope_integrate(
        [((0, 1), 3), ((1, -2), -1), ((-2, -1), -3)], 6 * x**2 - 40 * y
    ) == Rational(-935, 3)
    assert (
        polytope_integrate(
            [((-1, 0), 0), ((0, sqrt(3)), 3), ((sqrt(3), 0), 3), ((0, -1), 0)], 1
        )
        == 3
    )
    ...
    assert (
        polytope_integrate(
            Polygon(
                Point(-1, -1), Point(-1, 1), Point(1, 1), Point(0, 0), Point(1, -1)
            ),
            1,
        )
        == 3
    ...
    assert polytope_integrate(fig1, x**2 + x * y + y**2) == S(2031627344735367) / (
        8 * 10**12
    )
    ...
    assert polytope_integrate(fig2, x**2 + x * y + y**2) == S(517091313866043) / (
        16 * 10**11
    )
    ...
    assert polytope_integrate(fig3, x**2 + x * y + y**2) == S(147449361647041) / (
        8 * 10**12
    )
    ...
    assert polytope_integrate(fig4, x**2 + x * y + y**2) == S(180742845225803) / (
        10**12
    )
    ...
    #  calculated.
    assert polytope_integrate(
        Polygon(Point(0, 0), Point(0, 1), Point(1, 1), Point(1, 0)), max_degree=4
    ) == {
        0: 0,
        1: 1,
        x: S.Half,
    ...
    assert polytope_integrate(cube2, x**2 + y**2 + x * y + z**2) == Rational(
        15625, 4
    )
    ...
    assert (
        Abs(polytope_integrate(great_stellated_dodecahedron, 1) - 0.163118960624632)
        < 1e-12
    )
...
def test_polytopes_intersecting_sides():
    ...
    assert polytope_integrate(fig5, x**2 + x * y + y**2) == S(1633405224899363) / (
        24 * 10**12
    )
    ...
    assert polytope_integrate(fig6, x**2 + x * y + y**2) == S(88161333955921) / (
        3 * 10**12
    )
...
def test_integration_reduction_dynamic():
    ...
    assert integration_reduction_dynamic(
        facets, 0, a, b, x, 1, (x, y), 1, 0, 1, x0, monomial_values, 3
    ) == Rational(25, 2)
    assert (
        integration_reduction_dynamic(
            facets, 0, a, b, 0, 1, (x, y), 1, 0, 1, x0, monomial_values, 3
        )
        == 0
    )
