...
from sympy.categories.diagram_drawing import ArrowStringDescription, _GrowableGrid
...
def test_DiagramGrid():
    ...
    assert (
        str(grid) == '[[Object("A"), Object("B"), Object("D")], '
        '[None, Object("C"), None]]'
    )
...
def test_XypicDiagramDrawer_triangle():
    ...
    drawer = XypicDiagramDrawer()
    assert (
        drawer.draw(d, grid, masked=[f1 * g1 * g2 * f2, g2 * f2 * f1 * g1])
        == "\\xymatrix{\n"
