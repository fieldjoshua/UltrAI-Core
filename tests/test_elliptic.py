...
def test_jtheta_issue_79():
    ...
    res = (
        mpf("32.0031009628901652627099524264")
...
def test_sn_cn_dn_complex():
    ...
    res = (
        mpf("0.2495674401066275492326652143537")
    ...
    res = (
        mpf("0.9762691700944007312693721148331")
...
def test_elliptic_integrals():
    ...
    assert ellippi(2.0 - 0.5j, 0.5 + 1.0j).ae(
        0.936761970766645807 - 1.61876787838890786j
    )
