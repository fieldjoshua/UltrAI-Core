    ...
    def generate_report(self, initial_metrics, final_metrics, test_config):
        ...
        report = {
            ...
            "system_metrics": {
                ...
                "max_memory_mb": max([m["memory_mb"] for m in self.system_metrics])
                if self.system_metrics
                else 0,
            },
            "backend_metrics": {
                ...
                "delta": {
                    ...
                    "avg_processing_time": final_metrics.get("avg_processing_time")
                    if final_metrics
                    else None,
                    "max_memory_usage": final_metrics.get("max_memory_usage")
                    if final_metrics
                    else None,
                },
            },
