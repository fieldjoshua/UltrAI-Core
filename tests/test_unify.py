...
from sympy.unify.core import Compound, CondVariable, Variable, allcombinations
...
def unify(a, b, s={}):
    return core.unify(
        a, b, s=s, is_associative=is_associative, is_commutative=is_commutative
    )
