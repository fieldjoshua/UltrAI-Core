...
def main():
    ...
    print(f"Enterprise tier with Claude 3 Opus (2.5M tokens) + features: {cost_enterprise}\n")
    ...
    simulation_results = simulator.simulate_pricing(scenarios, output_dir="pricing_results")
    print(f"Simulation results: {simulation_results['summary']}\n")
    print(f"Detailed reports and visualizations saved to: {simulation_results['output_dir']}")
