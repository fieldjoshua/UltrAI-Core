from sympy.sets.ordinals import OmegaPower, Ordinal, omega, ord0
...
def test_string_ordinals():
    ...
    assert (
        str(Ordinal(OmegaPower(omega + 1, 1), OmegaPower(3, 2)))
        == "w**(w + 1) + w**3*2"
    )
...
def test_addition_with_integers():
    ...
    assert Ordinal(OmegaPower(5, 3), OmegaPower(0, 2)) + 3 == Ordinal(
        OmegaPower(5, 3), OmegaPower(0, 5)
    )
...
def test_addition_with_ordinals():
    ...
    assert Ordinal(OmegaPower(omega, 2), OmegaPower(3, 2)) + Ordinal(
        OmegaPower(4, 2)
