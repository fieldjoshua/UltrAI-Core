...
def test_perm_af_direct_product():
    ...
    gens2 = [[1, 0]]
    assert perm_af_direct_product(gens1, gens2, 0) == [
        [1, 0, 2, 3, 4, 5],
        [0, 1, 3, 2, 4, 5],
        [0, 1, 2, 3, 5, 4],
    ]
...
def test_dummy_sgs():
    ...
    assert a == [
        x._array_form for x in [Perm(9)(2, 3), Perm(9)(4, 5), Perm(9)(2, 4)(3, 5)]
    ]

    a = dummy_sgs([2, 3, 4, 5], 1, 8)
    assert a == [
        x._array_form for x in [Perm(2, 3)(8, 9), Perm(4, 5)(8, 9), Perm(9)(2, 4)(3, 5)]
    ]
...
def test_get_symmetric_group_sgs():
    ...
    assert get_symmetric_group_sgs(3) == (
        [0, 1],
        [Permutation(4)(0, 1), Permutation(4)(1, 2)],
    )
    assert get_symmetric_group_sgs(3, 1) == (
        [0, 1],
        [Permutation(0, 1)(3, 4), Permutation(1, 2)(3, 4)],
    )
    assert get_symmetric_group_sgs(4) == (
        [0, 1, 2],
        [Permutation(5)(0, 1), Permutation(5)(1, 2), Permutation(5)(2, 3)],
    )
...
def test_no_metric_symmetry():
    ...
    g = Permutation([2, 1, 0, 3, 4, 5])
    can = canonicalize(
        g, list(range(4)), None, [[], [Permutation(list(range(4)))], 2, 0]
    )
    ...
    can = canonicalize(
        g, list(range(8)), None, [[], [Permutation(list(range(4)))], 4, 0]
    )
    ...
    can = canonicalize(
        g, list(range(16)), None, [[], [Permutation(list(range(4)))], 8, 0]
    )
...
def test_canonicalize1():
    ...
    can = canonicalize(
        g, list(range(2, 6)), 0, (base2, gens2, 2, 0), (base2, gens2, 1, 0)
    )
    ...
    can = canonicalize(
        g, list(range(8)), 0, (base3, gens3, 2, 0), (base2a, gens2a, 1, 0)
    )
    assert can == 0
    ...
    can = canonicalize(
        g, list(range(8)), 0, (base3, gens3, 2, 1), (base2a, gens2a, 1, 0)
    )
    ...
    can = canonicalize(
        g, list(range(8)), 1, (base3, gens3, 2, 1), (base2a, gens2a, 1, 0)
    )
    ...
    can = canonicalize(
        g, list(range(8)), None, (base3, gens3, 2, 1), (base2a, gens2a, 1, 0)
    )
...
def test_riemann_invariants():
    ...
    can = canonicalize(
        ...
        (
            [2, 0],
            [Permutation([1, 0, 2, 3, 5, 4]), Permutation([2, 3, 0, 1, 4, 5])],
            1,
            0,
        ),
    )
...
def test_riemann_products():
    ...
    can = canonicalize(
        g, list(range(14)), 0, ((baser, gensr, 2, 0)), (base2, gens2, 3, 0)
    )
