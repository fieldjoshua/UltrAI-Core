...
def test_dup_gcd():
    ...
    f, g = x**2 + 2 * x + 1, 1
    assert (
        R.dup_zz_heu_gcd(f, g) == R.dup_rr_prs_gcd(f, g) == (1, x**2 + 2 * x + 1, 1)
    )

    f, g = x**2 + 2 * x + 1, 2
    assert (
        R.dup_zz_heu_gcd(f, g) == R.dup_rr_prs_gcd(f, g) == (1, x**2 + 2 * x + 1, 2)
    )

    f, g = 2 * x**2 + 4 * x + 2, 2
    assert (
        R.dup_zz_heu_gcd(f, g) == R.dup_rr_prs_gcd(f, g) == (2, x**2 + 2 * x + 1, 1)
    )

    f, g = 2, 2 * x**2 + 4 * x + 2
    assert (
        R.dup_zz_heu_gcd(f, g) == R.dup_rr_prs_gcd(f, g) == (2, 1, x**2 + 2 * x + 1)
    )
...
def test_dmp_gcd():
    ...
    f, g = x**2 + 2 * x + 1, 1
    assert (
        R.dmp_zz_heu_gcd(f, g) == R.dmp_rr_prs_gcd(f, g) == (1, x**2 + 2 * x + 1, 1)
    )

    f, g = x**2 + 2 * x + 1, 2
    assert (
        R.dmp_zz_heu_gcd(f, g) == R.dmp_rr_prs_gcd(f, g) == (1, x**2 + 2 * x + 1, 2)
    )

    f, g = 2 * x**2 + 4 * x + 2, 2
    assert (
        R.dmp_zz_heu_gcd(f, g) == R.dmp_rr_prs_gcd(f, g) == (2, x**2 + 2 * x + 1, 1)
    )

    f, g = 2, 2 * x**2 + 4 * x + 2
    assert (
        R.dmp_zz_heu_gcd(f, g) == R.dmp_rr_prs_gcd(f, g) == (2, 1, x**2 + 2 * x + 1)
    )
