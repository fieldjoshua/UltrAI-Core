...
def test_round_two():
    ...
    cases = (
        ...
        (
            x**3 + 3 * x**2 - 4 * x + 4,
            DM(
                [((1, 2), (1, 4), (1, 4)), (0, (1, 2), (1, 2)), (0, 0, 1)], QQ
            ).transpose(),
            -83,
        ),
        # F = 2^2 * 3
        (
            x**3 + 3 * x**2 + 3 * x - 3,
            DM([((1, 2), 0, (1, 2)), (0, 1, 0), (0, 0, 1)], QQ).transpose(),
            -108,
        ),
        # F = 2^3
        (
        ...
        (
            x**3 + 3 * x**2 + 5,
            DM([((1, 3), (1, 3), (1, 3)), (0, 1, 0), (0, 0, 1)], QQ).transpose(),
            -135,
        ),
        # F = 3^3
        (
        ...
        (
            x**3 + 6 * x**2 + 4,
            DM([((1, 3), (2, 3), (1, 3)), (0, 1, 0), (0, 0, (1, 2))], QQ).transpose(),
            -108,
        ),
        # F = 2^3 * 7
        (
        ...
        (
            x**3 + 4 * x**2 - 3 * x + 7,
            DM([((1, 5), (4, 5), (4, 5)), (0, 1, 0), (0, 0, 1)], QQ).transpose(),
            -175,
        ),
        # F = 7^2
        (
            x**3 + 8 * x**2 + 5 * x - 1,
            DM([((1, 7), (6, 7), (2, 7)), (0, 1, 0), (0, 0, 1)], QQ).transpose(),
            49,
        ),
        # F = 2 * 5 * 7
        (
            x**3 + 8 * x**2 - 2 * x + 6,
            DM([(1, 0, 0), (0, 1, 0), (0, 0, 1)], QQ).transpose(),
            -14700,
        ),
        # F = 2^2 * 3 * 5
        (
            x**3 + 6 * x**2 - 3 * x + 8,
            DM([(1, 0, 0), (0, (1, 4), (1, 4)), (0, 0, 1)], QQ).transpose(),
            -675,
        ),
        # F = 2 * 3^2 * 7
        (
            x**3 + 9 * x**2 + 6 * x - 8,
            DM([(1, 0, 0), (0, (1, 2), (1, 2)), (0, 0, 1)], QQ).transpose(),
            3969,
        ),
        # F = 2^2 * 3^2 * 7
        (
