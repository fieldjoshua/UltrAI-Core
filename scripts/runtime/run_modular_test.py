"""
Test script for the modular orchestrator.
"""
...
TEST_PROMPT = "Compare renewable energy sources like solar and wind power."


async def run_modular_test():
    print("\n" + "=" * 80)
    print("Modular Orchestrator Test")
    print("=" * 80)

    # Create the modular orchestrator
    orchestrator = create_from_env(modular=True, analysis_type="comparative")
    ...
    request = RequestConfig(
        ...
        analysis_type="comparative",  # Use comparative analysis
    )

    print(f"\nProcessing prompt: {TEST_PROMPT}")
    print("\nThis will demonstrate the modular orchestrator with comparative analysis.")
    print("Working...\n")
    ...
    if result.get("analysis_results"):
        ...
        print("Analysis type: comparative")
