  ...
  const patterns = [
    {
      id: 'gut',
      name: 'Gut Check',
      description: 'Rapid evaluation of different perspectives',
    },
    {
      id: 'confidence',
      name: 'Confidence Analysis',
      description: 'Evaluates the strength of each model response',
    },
    {
      id: 'critique',
      name: 'Critique Analysis',
      description: "Models critically evaluate each other's reasoning",
    },
    {
      id: 'perspective',
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                <div className="bg-gray-50 p-3 rounded border border-gray-200">
                  ...
                  <p className="font-medium">
                    {results.performance.total_time_seconds.toFixed(1)}s
                  </p>
                </div>
                <div className="bg-gray-50 p-3 rounded border border-gray-200">
                  <p className="text-xs text-gray-500">Models Used</p>
                  <p className="font-medium">
                    {Object.keys(results.model_responses || {}).length}
                  </p>
                </div>
                <div className="bg-gray-50 p-3 rounded border border-gray-200">
                  ...
                  <p className="font-medium">
                    {results.performance.token_counts &&
                      results.performance.token_counts[primaryModel]
                        ?.total_tokens}
                  </p>
                </div>
                <div className="bg-gray-50 p-3 rounded border border-gray-200">
          ...
          {results.model_responses && (
            <div className="mb-4">
              ...
              <div className="space-y-4">
                {Object.entries(results.model_responses).map(
                  ([model, response]) => (
                    <div
                      key={model}
