  ...
  return (
    <div className={`rounded-lg p-4 ${
      ...
      <div className="flex justify-between mt-2 text-sm">
        ...
        <div className="text-gray-600">
          {estimatedTimeRemaining !== undefined && status !== 'complete' && status !== 'error' && (
      ...
      {totalSteps > 1 && status !== 'idle' && (
        <div className="mt-4">
          <div className="flex justify-between mb-1">
            ...
            <span className="text-xs text-gray-600">{currentStep} of {totalSteps} steps</span>
          </div>
            ...
            {Array.from({ length: totalSteps }).map((_, i) => (
              <div
                ...
                className={`h-1.5 rounded-full flex-1 ${
                  ...
                  i === currentStep && (status === 'preparing' || status === 'analyzing') ? 'bg-blue-300' : 
                  'bg-gray-200'
                }`}
              />
            ))}
