...
export default function CyberWizardPro() {
  ...
  const getStepColor = (color: string) =>
    COLORS[color as keyof typeof COLORS] || COLORS.cyber;
      ...
      <div className="pointer-events-none fixed inset-0" style={{ zIndex: 3 }}>
        <img
          ...
          style={{
            ...
            animation:
              billboardState === 'processing'
                ? 'billboardPulse 2s ease-in-out infinite'
                : 'none',
              ...
              >
                ...
                {step.type === 'intro' && (
                  <div className="text-center space-y-6">
                    ...
                    <div className="grid grid-cols-2 gap-4 max-w-2xl mx-auto">
                      ...
                      >
                        <div style={{ color: COLORS.mint, fontSize: '18px' }}>
                          ✨
                        </div>
                        <div
                          style={{
                        ...
                        >
                          Multiple LLMs working together. Better results, fewer
                          blind spots.
                        </div>
                      </div>
                      <div
                      ...
                      >
                        <div style={{ color: COLORS.blue, fontSize: '18px' }}>
                          🚀
                        </div>
                        <div
                          style={{
                        ...
                        >
                          Select goals, enter query, choose models. We handle
                          the rest.
                        </div>
                      </div>
                    </div>
                ...
                {step.type !== 'intro' && (
                  <div
                    ...
                    style={{ padding: SPACING.xl, color: COLORS.text.muted }}
                  >
              ...
              >
                {summary.map((item, i) => (
                  <div
                    ...
                    style={{ color: getStepColor(item.color) }}
                  >
