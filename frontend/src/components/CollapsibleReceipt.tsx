...
export const CollapsibleReceipt: React.FC<CollapsibleReceiptProps> = ({
  ...
  return (
    ...
    >
      ...
      {/* Receipt content */}
      <div
        className={`${isMobile && isCollapsed ? 'hidden' : ''} ${isMobile ? 'px-4 pb-4' : 'p-6'}`}
      >
        {!isProcessing ? (
          <>
            <div className="text-center mb-2">
              <div className="text-[14px] font-extrabold tracking-[0.35em] text-white">
                ULTRAI
              </div>
          ...
          <>
            ...
            <div className="text-center mt-8">
              <div className="text-[12px] text-white/60">
                Ultra Synthesis™ in progress
              </div>
              <div className="text-[10px] text-white/40 mt-2">
                Check the status in the main panel
              </div>
            </div>
          </>
        )}
