      ...
      >
        ...
        <div
          ...
          style={{
            ...
            animation:
              state === 'processing'
                ? 'backgroundShift 20s linear infinite'
                : 'none',
          }}
        />
        ...
        <div className="relative h-full flex flex-col items-center justify-center">
          ...
          <h1
            ...
            style={{
              background:
                'linear-gradient(to right, #ff00de, #00ffff, #00ff9f)',
          ...
          {message && (
            <p
              ...
              style={{
                ...
                animation:
                  state === 'processing' ? 'pulse 1.5s infinite' : 'none',
              }}
            >
              {message}
            </p>
        ...
        <div
          ...
          style={{
            ...
            boxShadow:
              state === 'processing' ? '0 0 10px #00ffff' : '0 0 5px #ff00de',
            transition: 'all 0.5s ease',
          }}
        />
        <div
