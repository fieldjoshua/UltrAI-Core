...
export const useAnalysisConfig = (isOffline: boolean) => {
    ...
    const [selectedAnalysisType, setSelectedAnalysisType] = useState<string>('confidence'); // Default pattern
