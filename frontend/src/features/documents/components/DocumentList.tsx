...
import { fetchDocuments, deleteDocument, toggleDocumentSelection } from '../documentsSlice';
                                    ...
                                    <div className="flex items-center">
                                        ...
                                        <div className="ml-4">
                                            ...
                                            <div className="flex mt-1">
                                                <span className={`px-2 inline-flex text-xs leading-5 font-semibold rounded-full ${document.status === 'uploaded' ? 'bg-green-100 text-green-800' :
