...
const DocumentUpload: React.FC = () => {
    ...
    const { isLoading, uploadProgress, error } = useAppSelector((state) => state.documents);
    ...
    return (
        <div className="mt-4">
            ...
            <div
                className={`border-2 border-dashed rounded-lg p-6 text-center ${dragActive ? 'border-indigo-500 bg-indigo-50' : 'border-gray-300 hover:border-indigo-400'
                    }`}
            ...
            <button
                ...
                disabled={isLoading}
                className={`mt-4 w-full inline-flex justify-center py-2 px-4 border border-transparent shadow-sm text-sm font-medium rounded-md text-white ${isLoading
