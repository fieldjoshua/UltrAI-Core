      ...
      try {
        ...
        if (savedSharedItems) {
          ...
          if (item) {
            ...
            setError(
              'Shared analysis not found. It may have been deleted or the link is invalid.'
            );
          }
        } else {
          setError(
            'No shared analyses found. The content may have been deleted.'
          );
        }
      } catch (err) {
      ...
      <div className="max-w-4xl mx-auto bg-black border-4 border-cyan-700 rounded-lg shadow-2xl shadow-cyan-500/20 p-6 md:p-8">
        ...
        <div className="mt-8 text-center">
          <p className="text-gray-500 text-sm">
            This is a shared analysis from UltrAI - Multiple AI models working
            together to provide better results.
          </p>
