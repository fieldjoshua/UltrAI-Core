"""Alembic environment configuration for UltraAI Core database migrations."""
...
from app.database.models import Base  # This imports all models via __init__.py
from app.database.models.user import User, ApiKey
...
def run_migrations_online() -> None:
    ...
    """
    # Handle connection pool settings for different databases
    poolclass = None
