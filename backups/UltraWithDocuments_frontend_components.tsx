...
export default function UltraWithDocuments() {
  ...
  // New state for a la carte options and output format
  ...
  const handleAnalyze = async () => {
    try {
      ...
      const payload = {
        ...
        ala_carte_options: selectedAlaCarteOptions,
      ...
      // Simulate progress updates (or use real API)
      ...
      try {
        ...
        const api = `${API_URL}/api/analyze-with-docs`;
...
${selectedAlaCarteOptions.length > 0 ? `* A la carte options: ${selectedAlaCarteOptions.join(', ')}` : ''}
...
- Models: ${selectedLLMs.join(', ')}`,
    ...
    return (
      <div className="mb-8">
        <div className="flex justify-between w-full mb-2">
          <div
            className={`text-sm font-medium ${currentStep === 'PROMPT' ? 'text-cyan-400' : 'text-gray-500'
              }`}
          >
            1. Enter Prompt
          </div>
          <div
            className={`text-sm font-medium ${currentStep === 'DOCUMENTS' ? 'text-cyan-400' : 'text-gray-500'
              }`}
          >
            2. Add Context
          </div>
          <div
            className={`text-sm font-medium ${currentStep === 'MODELS' ? 'text-cyan-400' : 'text-gray-500'
              }`}
          >
            3. Select AI Models
          </div>
          <div
            className={`text-sm font-medium ${currentStep === 'ANALYSIS_TYPE'
              ? 'text-cyan-400'
              : 'text-gray-500'
              }`}
          >
          ...
          <div
            className={`text-sm font-medium ${currentStep === 'OPTIONS'
              ? 'text-cyan-400'
              : 'text-gray-500'
              }`}
          >
            5. Select A La Carte Options
          </div>
          <div
            className={`text-sm font-medium ${currentStep === 'PROCESSING'
              ? 'text-cyan-400'
              : 'text-gray-500'
              }`}
          >
          ...
          <div
            className={`text-sm font-medium ${['PROCESSING', 'RESULTS'].includes(currentStep)
              ? 'text-cyan-400'
              : 'text-gray-500'
              }`}
          >
        ...
        return (
          <div className="space-y-6">
                  ...
                  {alaCarteOptions.map((option) => {
                    ...
                    return (
                      <div
                        ...
                        `}
                        onClick={() => handleAlaCarteOptionToggle(option.id)}
                      >
                        <div className="flex items-center">
                          <div
            ...
            <div className="flex justify-between">
              <button
                onClick={goToPreviousStep}
                className="px-4 py-2 bg-gray-100 dark:bg-gray-800 text-gray-700 dark:text-gray-300 rounded hover:bg-gray-200 dark:hover:bg-gray-700 transition"
              >
                Back
              </button>
              <button
  ...
  // Handler for a la carte options selection
