  ...
  return (
    <div className="space-y-1">
      <div className="flex items-center justify-between text-xs mb-1">
        ...
        <span className="text-gray-300 font-mono">{value.toFixed(value < 10 ? 1 : 0)}</span>
      </div>
          ...
          <div className="grid grid-cols-2 gap-2 text-xs text-gray-400 mt-2 border-t border-gray-800 pt-2">
            <div>
              <div className="flex justify-between">
                <span>Uptime:</span>
                <span className="text-gray-300">{derivedMetrics.uptimeFormatted}</span>
              </div>
              <div className="flex justify-between">
                <span>Memory Cache Items:</span>
                <span className="text-gray-300">{metrics.cache_stats?.memory_cache_size || 0}</span>
              </div>
            </div>
            <div>
              <div className="flex justify-between">
                <span>Total Chunks:</span>
                <span className="text-gray-300">{metrics.total_chunks_processed}</span>
              </div>
              <div className="flex justify-between">
                <span>Peak Memory (MB):</span>
                <span className="text-gray-300">{metrics.max_memory_usage.toFixed(1)}</span>
              </div>
            </div>
          </div>
        </div>
