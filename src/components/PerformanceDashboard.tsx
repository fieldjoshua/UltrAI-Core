...
export const PerformanceDashboard = () => {
  ...
  const updateMetricsHistory = useCallback((newMetrics: PerformanceMetrics) => {
    setMetricsHistory(prev => {
      ...
      const processing_time = [...prev.processing_time, newMetrics.avg_processing_time].slice(-HISTORY_LIMIT);
        ...
        <div className="flex items-center justify-between mb-6">
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              ...
              `}
            >
              <Activity className={`w-4 h-4 ${autoRefresh ? 'text-cyan-400' : ''}`} />
                  ...
                  <div className="space-y-4">
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-2">
                        ...
                        <span className="text-sm">Average document processing time</span>
                      </div>
                    ...
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-2">
                        ...
                        <span className="text-sm">Chunks per document (avg)</span>
                      </div>
                      <span className="text-cyan-300 font-mono">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <span className="text-cyan-300 font-mono">
                        {healthResponse.system_info.python_version.split(' ')[0]}
                      </span>
                    </div>
                  </div>
                </div>
