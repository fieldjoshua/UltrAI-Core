"""
Configuration module for Simple Core Orchestrator.

This module provides configuration classes for the Simple Core Orchestrator with
a focus on simplicity and directness.
"""
