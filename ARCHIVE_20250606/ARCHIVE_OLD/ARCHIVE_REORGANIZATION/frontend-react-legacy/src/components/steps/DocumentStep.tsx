  ...
  if (isOffline && !isUsingDocuments) {
    ...
    return (
      <p className="text-center text-gray-500">
        Document upload unavailable while offline.
      </p>
    );
  }
    ...
    <div className="space-y-6 fadeIn">
      <div className="mb-4">
        ...
        <p className="text-sm text-gray-600 dark:text-gray-400 mb-4">
          Upload files that provide context or information relevant to your
          query (optional).
        </p>
      </div>
      ...
      {isUsingDocuments && (
        <div className="space-y-4">
          ...
          >
            <Upload
              className={`h-10 w-10 mx-auto mb-3 ${isOffline ? 'text-gray-600' : 'text-gray-400 dark:text-gray-600'}`}
            />
            <p
              className={`text-gray-600 dark:text-gray-400 ${isOffline ? 'text-gray-500' : ''}`}
            >
              {isOffline
                ? 'File upload disabled offline'
